...
<div class="row">
    ...
    <div class="col-md-4 col-md-offset-4" style="padding-top: 10px;padding-bottom: 20px;" >
        ...
        if (isset($_POST['sub'])) {
            ...
            $result = mysqli_query($link, "update tbl_hospital set status='0' where id='$id'");

            if (mysqli_affected_rows($link)) {
                echo "<script>document.getElementById('result').innerHTML='Deleted SuccessFully..';</script>";
            } else {
                echo "<script>document.getElementById('resulte').innerHTML='Deletion Failed..';</script>";
            }
        }
        ?>
    </div>
