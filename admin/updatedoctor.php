...
if (isset($_GET['id'])) {
    ...
    if (mysqli_affected_rows($link)) {
        ...
        if (isset($_POST['sub'])) {
            ...
            $result = mysqli_query($link, "update tbl_doctors set h_id='$hid',name='$name',department='$depart',qualification='$Q',photo='$photo',experience='$exp' where id='$id'");
            if (mysqli_affected_rows($link)) {
