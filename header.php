                                        ...
                                        <div class="container-fluid col-md-10 col-md-offset-1" style="padding-bottom: 15px;padding-top: 15px;">
                                            ...
                                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                                <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li><a href="index/" class="alink" >Home <span class="sr-only">(current)</span></a></li>
                                                    <li><a href="about-hospital-project/" class="alink">About us</a></li>      
                                                    <li><a href="login-to-your-account/"  class="alink">Login</a></li>
