...
$data = mysqli_query($link, "Select * from tbl_doctors where h_id='$hid'");
if (mysqli_affected_rows($link)) {
    while ($row = mysqli_fetch_array($data)) {
        ?>
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 table-responsive" style="padding-top:10px;padding-bottom:10px;">
                        <div class="col-md-2" align='center'><img src="<?= $row['photo']; ?>" class="img-responsive img-thumbnail"></div>
