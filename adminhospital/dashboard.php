...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row" style="position:relative;top:40px;">
                <div class="col-md-4 col-md-offset-4">
                    <form method="post">
                        <h4 align="center"><b>Hospital Login</b></h4>
                        <h5><b>UserName</b></h5>
                    ...
                    <p id="expire" style="color:red"></p>
                    <a href="forget.php" style="color:black;">Forgot:Username/Password?</a>
                </div>
            </div>
            <!---end-->
        ...
        if (isset($_POST['submit'])) {
            ...
            $data = mysqli_query($link, "select * from  tbl_hospital where login='$login' and password='$password'");
            if (mysqli_num_rows($data) > 0) {
                $row = mysqli_fetch_array($data);
                if ($row['status'] == 0) {
                    echo "<script>document.getElementById('expire').innerHTML='Your Subsciption is over charge again...';</script>";
                } else {
                    $_SESSION["hospitalid"] = $row[0];
                    header("location:success.php");
                }
            } else {
