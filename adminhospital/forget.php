        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_affected_rows($link)) {
                ...
                if (($password != $cpassword) || ($row['secure'] != $sq)) {
                    ...
                    echo "<script>document.getElementById('mm').innerHTML='Your Subsciption is over charge again...';</script>";
                } else {
                    mysqli_query($link, "update tbl_hospital set password='$password' where login='$login'");
