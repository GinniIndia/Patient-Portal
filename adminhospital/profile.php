            ...
            if (isset($_GET['id']) && isset($_GET['did'])) {
                ...
                if (mysqli_affected_rows($link)) {
                    ...
                    if (mysqli_affected_rows($link)) {
                        ...
                        <tr>
                            <td><?= $row['id']; ?></td>
                            <td align='center'><img src="<?= $photo; ?>" class='img-responsive img-thumbnail' alt="<?= $photo; ?>"></td>
                        ...
                        <tr>
                            <td><?= $row1['id']; ?></td>
                            <td align='center'><img src="<?= $photo1; ?>" class='img-responsive img-thumbnail' alt="<?= $photo1; ?>"></td>
